...
const featureCategories: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      { name: "Blockchain networks", tooltip: "Monitor 55+ blockchain networks including L1, L2, DeFi, and RPC providers", free: "Up to 1", essential: false, growth: "Up to 25", enterprise: "Unlimited" },
