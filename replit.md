...
- **UI Declutter**: Configuration section (parser, endpoint) hidden for non-admin users. Status page link removed from vendor cards (still visible in detail). Incident cards show simplified status/date info.