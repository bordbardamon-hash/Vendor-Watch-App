...
- **Expanded Service Directory**: 108 vendors monitored (up from 75), adding 47+ services including Vercel, Netlify, Supabase, OpenAI, Anthropic, MongoDB, Shopify, and many more developer tools, cloud/infrastructure, and SaaS platforms.