...
const DEFAULT_VENDORS: InsertVendor[] = [
  ...
  { key: "loom", name: "Loom", statusUrl: "https://status.loom.com", parser: "manual", status: "operational" },
  ...
  // CRM & Marketing
  { key: "freshworks", name: "Freshworks", statusUrl: "https://status.freshworks.com", parser: "manual", status: "operational" },
  { key: "zendesk", name: "Zendesk", statusUrl: "https://status.zendesk.com", parser: "manual", status: "operational" },
  { key: "pipedrive", name: "Pipedrive", statusUrl: "https://status.pipedrive.com", parser: "manual", status: "operational" },
  ...
  { key: "mailchimp", name: "Mailchimp", statusUrl: "https://status.mailchimp.com", parser: "manual", status: "operational" },
  // Developer Tools
  { key: "gitlab", name: "GitLab", statusUrl: "https://status.gitlab.com", parser: "manual", status: "operational" },
  { key: "heroku", name: "Heroku", statusUrl: "https://status.heroku.com", parser: "manual", status: "operational" },
  ...
  { key: "jira", name: "Jira", statusUrl: "https://jira.status.atlassian.com", parser: "manual", status: "operational" },
  { key: "npm", name: "npm", statusUrl: "https://status.npmjs.org", parser: "statuspage_json", status: "operational" },
  { key: "pagerduty", name: "PagerDuty", statusUrl: "https://status.pagerduty.com", parser: "manual", status: "operational" },
  // Analytics & Data
  ...
  // Security
  { key: "crowdstrike", name: "CrowdStrike", statusUrl: "https://status.crowdstrike.com", parser: "manual", status: "operational" },
  { key: "sophos", name: "Sophos", statusUrl: "https://status.sophos.com", parser: "manual", status: "operational" },
  ...
  // Other Services
  { key: "automattic", name: "WooCommerce/Automattic", statusUrl: "https://automatticstatus.com", parser: "manual", status: "operational" },
  { key: "braintree", name: "Braintree", statusUrl: "https://status.braintreepayments.com", parser: "manual", status: "operational" },
  { key: "postmark", name: "Postmark", statusUrl: "https://status.postmarkapp.com", parser: "manual", status: "operational" },
  ...
  { key: "zoho", name: "Zoho", statusUrl: "https://status.zoho.com", parser: "manual", status: "operational" },
  // Additional Enterprise Services (to reach 100)
  { key: "servicenow", name: "ServiceNow", statusUrl: "https://status.servicenow.com/", parser: "manual", status: "operational" },
  { key: "workday", name: "Workday", statusUrl: "https://status.workday.com/", parser: "manual", status: "operational" },
  ...
  { key: "webex", name: "Webex", statusUrl: "https://status.webex.com/", parser: "manual", status: "operational" },
  { key: "splunk", name: "Splunk", statusUrl: "https://status.splunk.com/", parser: "manual", status: "operational" },
  ...
  { key: "algolia", name: "Algolia", statusUrl: "https://www.algoliastatus.com/", parser: "statuspage_json", status: "operational" },
];
